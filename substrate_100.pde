// http://www.complexification.net/gallery/machines/substrate/appletl/substrate_l.pde
...
// Processing 3 Fork by Rupert Russell
...
class SandPainter {
  ...
  void render(float x, float y, float ox, float oy) {
    ...
    for (int i=0;i<grains;i++) {
      ...
      ellipse(ox+(x-ox)*sin(sin(i*w)),oy+(y-oy)*sin(sin(i*w)),3,3);
     // println(ox+(x-ox)*sin(sin(i*w)),oy+(y-oy)*sin(sin(i*w)));
    }
  }
}
